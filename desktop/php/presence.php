                    ...
                    <fieldset>
                        ...
                        <div>
                            ...
                            <div class="col-md-3" style="border: 1px solid #eee; border-left-width: 5px; border-radius: 3px; border-left-color: #428bca;">
                                <a style="color: #428bca;">{{Ajoutés}} : </a>
                            ...
                            <div class="col-md-3 col-md-offset-1"  style="border: 1px solid #eee; border-left-width: 5px; border-radius: 3px; border-left-color: #d9534f;">
                                <a style="color: #428bca;">{{Disponibles}} : </a>
                        ...
                        <form class="form-horizontal">
                            <div class="form-group">
                                <fieldset class="col-md-6">
                                    ...
                                    <div>
                                        {{Garder le cache  lors de l'enregistrement}} : <label class="checkbox-inline"><input type="checkbox" class="eqLogicAttr" data-l1key="configuration" data-l2key="cache_cleanup" checked/>&nbsp;</label>
                                    </div>	
                                    <div style="padding-top:0.3em">
                                        {{Toujours exécuter les actions de retour de vacances}} : <label class="checkbox-inline"><input type="checkbox" class="eqLogicAttr" data-l1key="configuration" data-l2key="execute_return_holliday" checked/>&nbsp;</label> 
                                    </div>		
                                    <div  style="padding-top:0.3em">
                                        <p>{{Modes pour lesquels la simulation est active}} :<br/><br/>
                                ...
                                <fieldset class="col-md-6">
                                    ...
                                    <div>
                                        <div>
                                            {{Modes à afficher }} :<br/><br/>
                                            <select id="view_modes" multiple="multiple">
                                                <option value="Vacances">{{Vacances}}</option>
                                            </select>
                                        </div>
                                        <div style="padding-top:0.3em; vertical-align: center;">
                                            {{Bouton de verrouilage}} : <label class="checkbox-inline"><input type="checkbox" class="eqLogicAttr" data-l1key="configuration" data-l2key="lock_visible" checked/>&nbsp;</label>
                                        ...
                                        <div style="padding-top:0.3em">
                                            {{Afficher le nom du mode sur le widget}} : <label class="checkbox-inline"><input type="checkbox" class="eqLogicAttr" data-l1key="configuration" data-l2key="display_names" checked/>&nbsp;</label>
                                        </div>	
                                        <div style="padding-top:0.3em">
                                            {{Icônes sur les boutons}} : <label class="checkbox-inline"><input type="checkbox" class="eqLogicAttr" data-l1key="configuration" data-l2key="button_display_name" checked/>&nbsp;</label>
                                        </div>										
                                    </div>
                                </fieldset>
                            </div>

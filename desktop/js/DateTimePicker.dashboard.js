		...
		DateTimePicker.prototype = {
			...
			_setButtonAction: function()
			{
				...
				if(dtPickerObj.dataObject.oInputElement != null)
				{
					...
					var id_cmd_parent = this.element.parentNode.parentNode;
					var id_cmd = id_cmd_parent.getAttribute("data-cmd_id");
					//console.log(id_cmd.getAttribute("data-cmd_id"));
					
					$.get( "plugins/presence/core/php/jeePresence.php?cmd_id= " + id_cmd + "&date=" + sOutput);			
